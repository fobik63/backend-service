...
export const dictionaries = {
  ru: {
    ...
    editor: {
      ...
      parserTitle: "Парсер товара",
      parserHint:
        "Вставьте ссылку или артикул — фото уйдёт в вырезку, поля заполнятся автоматически",
      ...
      eyeTitle: "Глаз Бога",
      eyeHint:
        "Введите артикул конкурента — найдём ТОП-10 похожих карточек и разберём плашки, триггеры и визуал",
  ...
  en: {
    ...
    editor: {
      ...
      parserTitle: "Product parser",
      parserHint:
        "Paste a link or SKU — the photo goes into the cutout and fields fill automatically",
      ...
      eyeTitle: "Eye of God",
      eyeHint:
        "Enter a competitor SKU — we find the TOP-10 similar cards and break down badges, triggers, and visuals",
