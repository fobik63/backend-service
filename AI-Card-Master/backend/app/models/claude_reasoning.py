"""ORM models for Claude 4.7 Vision & Reasoning async jobs."""
...
class ClaudeReasoningOutbox(Base):
    """Transactional messages published to Celery after job commit."""

    __tablename__ = "claude_analysis_outbox"
